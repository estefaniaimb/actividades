...
class vehiculo(object):
	def __init__(self,modelo,cilindraje,numero_ejes):
		self.modelo = modelo
		self.cilindraje = cilindraje
		self.numero_ejes = numero_ejes
	def det_vehiculo(self):
		return '\n\t\tModelo: '+str(self.modelo)+'\n\t\tCilindraje: '+str(self.cilindraje)+'\n\t\tNumero de ejes: '+str(self.numero_ejes)


class vehiculo_aereo(vehiculo):
	def __init__(self,modelo,cilindraje,numero_ejes,numero_alas,numero_alerones):
		vehiculo.__init__(self,modelo,cilindraje,numero_ejes)
		self.numero_alas = numero_alas
		self.numero_alerones = numero_alerones
	def det_aereo(self):
		return '\n\t\tNumero de alas: '+str(self.numero_alas)+'\n\t\tNumero de alerones: '+str(self.numero_alerones)

class vehiculo_espacial(vehiculo_aereo):
	def __init__(self,modelo,cilindraje,numero_ejes,numero_alas,numero_alerones,n_cohetes):
		vehiculo_aereo.__init__(self,modelo,cilindraje,numero_ejes,numero_alas,numero_alerones)
...
numero_ejes = array_vehiculo[1][2]
v1 = vehiculo(modelo, cilindraje,numero_ejes)
print '\n\tVehiculo\n'+v1.det_vehiculo()

modelo = array_vehiculo[2][0]
cilindraje = array_vehiculo[2][1]
numero_ejes = array_vehiculo[2][2]
v2 = vehiculo(modelo, cilindraje,numero_ejes)
print '\n\tVehiculo\n'+v2.det_vehiculo()

modelo = array_vehiculo[3][0]
cilindraje = array_vehiculo[3][1]
numero_ejes = array_vehiculo[3][2]
numero_alas = array_vehiculo[3][3]
numero_alerones = array_vehiculo[3][4]
v3 = vehiculo_aereo(modelo,cilindraje,numero_ejes,numero_alas,numero_alerones)
print '\n\tVehiculo aereo\n'+v3.det_vehiculo() 
print v3.det_aereo()

modelo = array_vehiculo[4][0]
cilindraje = array_vehiculo[4][1]
numero_ejes = array_vehiculo[4][2]
numero_alas = array_vehiculo[4][3]
numero_alerones = array_vehiculo[4][4]
n_cohetes = array_vehiculo[4][5]
v4 = vehiculo_espacial(modelo,cilindraje,numero_ejes,numero_alas,numero_alerones,n_cohetes)
print '\n\tVehiculo espacial\n'+v4.det_vehiculo() 
print v4.det_aereo()
